...
export function ExpandedSearch({
  ...
  return (
    <>
      ...
      <div
        id="expanded-search"
        className="search-container absolute left-0 right-0 bg-white rounded-b-2xl border border-gray-200 border-t-0 py-4 px-6 z-50 animate-in slide-in-from-top-2 fade-in duration-300 ease-out"
        onMouseDown={(e) => e.stopPropagation()}
      >
        <div className="container flex flex-nowrap items-center mx-auto max-w-3xl gap-4">
          <div className="flex rounded-2xl border border-gray-300 overflow-hidden flex-1 h-14 min-w-0">
            <LocationInput
              location={location}
